...
"""
    ...
    def train(self, config: Configuration, seed: int = 0):
        ...
        # ------------------------------------------------------------------
        expected_files = [path + "/eclipse-project/Aliasing/" + i + "/expected-info-flows.txt" for i
                          in names]
        ...
        output_files = [
            path + "/eclipse-project/Aliasing/" + i + f"/{callbackanalyzer}_{aliasalgo}_{layoutmode}.xml".format(
